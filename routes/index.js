...
app.get('/CartPos',checkCartin);
app.get('/CartPos',function(req,res){
res.render('CartPos.ejs',{CartPos1:resx[1],CartPos2:resy[1],CartPos3:resz[1],CartPos4:resrx[1],CartPos5:resry[1],CartPos6:resrz[1]});
});
function checkCartin(req,res,next){ 
  function __Server0headsession(IpAdress,port,SessionId){
          Server0headstr="POST / HTTP/1.1\r\n"+"Content-Type: text/xml; charset=utf-8\r\n"+"SOAPAction: \"\"\r\n";
...
//********************************x的值********************************************//
  var str1=data.toString();
　 var regx = /<x>(\-?[0-9]+\.[0-9]+)<\/x>/g; 
  resx=regx.exec(str1);
//*********************************************************************************//
//********************************y的值********************************************//
　 var regy = /<y>(\-?[0-9]+\.[0-9]+)<\/y>/g; 
  resy=regy.exec(str1);
//*********************************************************************************//
//********************************z的值********************************************//
　 var regz = /<z>(\-?[0-9]+\.[0-9]+)<\/z>/g; 
 resz=regz.exec(str1);
//*********************************************************************************//
//********************************rx的值********************************************//
　 var regrx = /<rx>(\-?[0-9]+\.[0-9]+)<\/rx>/g; 
  resrx=regrx.exec(str1);
//*********************************************************************************//
//********************************ry的值********************************************//
　 var regry = /<ry>(\-?[0-9]+\.[0-9]+)<\/ry>/g; 
  resry=regry.exec(str1);
//*********************************************************************************//
//********************************rz的值********************************************//
　 var regrz = /<rz>(\-?[0-9]+\.[0-9]+)<\/rz>/g; 
  resrz=regrz.exec(str1);
//*********************************************************************************//
  client.end();
  });
}
